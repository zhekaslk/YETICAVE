...
--
-- Хост: localhost:3306
-- Время создания: Май 30 2019 г., 05:04
...
CREATE TABLE `lot` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL COMMENT 'наименование лота',
  `message` text COMMENT 'описание лота',
...
(1, '2014 Rossingol District Snowboard', '', 'img/lot-1.jpg', 10999, 1000, NULL, NULL, NULL, 1, 1, 2),
(2, 'DC Ply Mens 2016/2017 Snowboard', 'Сноу агонь!', 'img/lot-2.jpg', 159999, 1000, NULL, '2019-05-30', '2019-06-30', 1, 4, NULL),
(3, 'Крепления Union Contact Pro 2015 года размер L/XL', 'Крепления что надо!', 'img/lot-3.jpg', 8000, 500, NULL, '2019-05-28', '2019-06-30', 3, 4, NULL),
(4, 'Ботинки для сноуборда DC Mutiny Charocal', 'Боты как на тебя шили!', 'img/lot-4.jpg', 10999, 1001, NULL, '2019-05-07', '2019-06-28', 2, 4, NULL),
...
(1, 'Иван', 'ivan@gmail.com', 'qwest12345', NULL, NULL, NULL),
(2, 'Игнат', 'ignat.v@gmail.com', '$2y$10$OqvsKHQwr0Wk6FMZDoHo1uHoXd4UdxJG/5UDtUiie00XaxMHrW8ka', NULL, NULL, NULL),
...
--
ALTER TABLE `lot`
  ADD CONSTRAINT `lot_ibfk_1` FOREIGN KEY (`id_category`) REFERENCES `category` (`id`),
  ADD CONSTRAINT `lot_ibfk_2` FOREIGN KEY (`id_author`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `lot_ibfk_3` FOREIGN KEY (`id_winner`) REFERENCES `users` (`id`);

--
-- Ограничения внешнего ключа таблицы `rate`
--
ALTER TABLE `rate`
  ADD CONSTRAINT `rate_ibfk_1` FOREIGN KEY (`id_lot`) REFERENCES `lot` (`id`),
