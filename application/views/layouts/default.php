...
<head>
    ...
    <link href="/public/styles/normalize.min.css" rel="stylesheet">
...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <a class="main-header__logo">
            <img src="/public/img/logo.svg" width="160" height="39" alt="Логотип компании YetiCave">
        </a>
        <form class="main-header__search" method="get" action="/search?">
            <input type="search" name="query" placeholder="Поиск лота" value="<?= isset($_GET['query']) ? $_GET['query'] : ""?>">
